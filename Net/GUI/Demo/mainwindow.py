...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_Image.setMaximumSize(QtCore.QSize(800, 452))
        self.label_Image.setContextMenuPolicy(QtCore.Qt.DefaultContextMenu)
        self.label_Image.setText("")
        self.label_Image.setObjectName("label_Image")
        self.verticalLayout_widgetVideo.addWidget(self.label_Image)
        self.widgetVideo = QtWidgets.QWidget(self.centralwidget)
        self.widgetVideo.setMaximumSize(QtCore.QSize(508, 299))
        self.widgetVideo.setLayoutDirection(QtCore.Qt.LeftToRight)
