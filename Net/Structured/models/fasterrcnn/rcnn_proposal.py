...
class RCNNProposal:
    """Create final object detection proposals.
        ...
        of the RCNN (both classification and bounding box adjusting) and generates
    ...
    def __init__(self, config):
        ...
        self.class_max_detections   = self.config.rcnn_class_max_detections
        # NMS intersection over union threshold to be used for classes.
        self.class_nms_threshold    = float(self.config.rcnn_class_nms_threshold)
        # Maximum number of detections to return.
        self.total_max_detections   = self.config.rcnn_total_max_detections
        # Threshold probability
        self.min_prob_threshold     = self.config.rcnn_min_prob_threshold or 0.0


    def get_proposals(self, proposals, bbox_pred, cls_prob, img_shape):
        """
        Args:
        ...
        for class_id in range(self.num_classes):
            ...
            class_selected_idx  = tf.image.non_max_suppression(
                class_objects_tf, class_prob, self.class_max_detections,
                iou_threshold=self.class_nms_threshold
            )
