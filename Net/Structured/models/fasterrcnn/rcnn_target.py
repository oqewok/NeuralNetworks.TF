...
class RCNNTarget:
    ...
    def __init__(self, config):
        ...
        self.variances          = self.config.rcnn_target_norm_variances

        # Ratio of foreground vs background for the minibatch.
        self.foreground_fraction        = self.config.rcnn_foreground_fraction
        self.minibatch_size             = self.config.minibatch_size
        # IoU lower threshold with a ground truth box to be considered that
        # specific class.
        self.foreground_threshold       = self.config.rcnn_foreground_threshold
        # High and low treshold to be considered background.
        self.background_threshold_high  = self.config.rcnn_background_threshold_high
        self.background_threshold_low   = self.config.rcnn_background_threshold_low


    def get_targets(self, proposals, gt_boxes):
        """
                Args:
        ...
        iou_is_high_enough_for_bg = tf.greater_equal(
            max_overlaps, self.background_threshold_low
        )
        iou_is_not_too_high_for_bg = tf.less(
            max_overlaps, self.background_threshold_high
        )
        ...
        max_fg = int(self.foreground_fraction * self.minibatch_size)
        ...
        max_bg = self.minibatch_size - total_fg_in_batch
