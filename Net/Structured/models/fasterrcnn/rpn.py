...
class RPN:
    ...
    def predict(self):
        ...
        self.rpn_conv_feature       = convolution(
            self.conv_feats, 3, 3, 512, 1, 1, 'rpn_conv', init_w="normal", stddev=0.001, reg=self.reg,  group_id=1
        ...
        self.rpn_cls_score_original  = convolution(
            self.rpn_feature, 1, 1, 2 * self.anchors_count, 1, 1, 'rpn_cls', init_w="normal", stddev=0.001, reg=self.reg, group_id=1
