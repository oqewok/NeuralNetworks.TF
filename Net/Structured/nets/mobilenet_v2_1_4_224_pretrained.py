...
def get_mobilenet_v2_1_4_pretrained():
    with open("C:\\Users\\admin\\Documents\\GeneralProjectData\\mobilenet\\mobilenet_v2_1.4_224\\mobilenet_v2_1.4_224_frozen.pb", mode='rb') as f:
        fileContent = f.read()
    ...
    with tf.Session() as sess:
        ...
        feature_map = tf.reshape(feature_map, [1, 14, 14, 136])

        return input, feature_map, [14, 14, 136]


if __name__ == '__main__':
    get_mobilenet_v2_1_4_pretrained()